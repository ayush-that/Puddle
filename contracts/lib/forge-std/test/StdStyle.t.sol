...
contract StdStyleTest is Test {
    function test_StyleColor() public pure {
        ...
        console2.log(
            StdStyle.redBytes(hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D")
        );
        ...
        console2.log(
            StdStyle.greenBytes(hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D")
        );
        ...
        console2.log(
            StdStyle.yellowBytes(hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D")
        );
        ...
        console2.log(
            StdStyle.blueBytes(hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D")
        );
        ...
        console2.log(
            StdStyle.magentaBytes(hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D")
        );
        ...
        console2.log(
            StdStyle.cyanBytes(hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D")
        );
    ...
    function test_StyleFontWeight() public pure {
        ...
        console2.log(
            StdStyle.boldBytes(hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D")
        );
        ...
        console2.log(
            StdStyle.dimBytes(hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D")
        );
        ...
        console2.log(
            StdStyle.italicBytes(hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D")
        );
        ...
        console2.log(
            StdStyle.underlineBytes(
                hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D"
            )
        );
        ...
        console2.log(
            StdStyle.inverseBytes(hex"7109709ECfa91a80626fF3989D68f67F5b1DD12D")
        );
