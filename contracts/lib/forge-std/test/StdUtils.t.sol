...
contract StdUtilsTest is Test {
    ...
    function testFuzz_Bound_DistributionIsEven(
        uint256 min,
        uint256 size
    ) public pure {
        size = (size % 100) + 1;
    ...
    function testFuzz_RevertIf_BoundMaxLessThanMin(
        uint256 num,
        uint256 min,
        uint256 max
    ) public {
    ...
    function testFuzz_BoundInt_DistributionIsEven(
        int256 min,
        uint256 size
    ) public pure {
        size = (size % 100) + 1;
    ...
    function testFuzz_RevertIf_BoundIntMaxLessThanMin(
        int256 num,
        int256 min,
        int256 max
    ) public {
    ...
    function test_BoundPrivateKey() public pure {
        ...
        assertEq(
            boundPrivateKey(UINT256_MAX),
            UINT256_MAX & (SECP256K1_ORDER - 1)
