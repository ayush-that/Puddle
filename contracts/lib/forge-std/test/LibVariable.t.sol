...
contract LibVariableTest is Test {
    ...
    function setUp() public {
        ...
        addressVar = Variable(
            Type(TypeKind.Address, false),
            abi.encode(address(0xdeadbeef))
        );
        bytes32Var = Variable(
            Type(TypeKind.Bytes32, false),
            abi.encode(bytes32(uint256(42)))
        );
        uintVar = Variable(
        ...
        intVar = Variable(
            ...
            abi.encode(int256(-123))
        );
        stringVar = Variable(
            Type(TypeKind.String, false),
            abi.encode("hello world")
        );
        bytesVar = Variable(
            Type(TypeKind.Bytes, false),
            abi.encode(hex"c0ffee")
        );
        ...
        addrs[0] = address(0x1);
        addrs[1] = address(0x2);
        addressArrayVar = Variable(
            Type(TypeKind.Address, true),
            abi.encode(addrs)
        );
        ...
        bytes32ArrayVar = Variable(
            Type(TypeKind.Bytes32, true),
            abi.encode(b32s)
        );
        ...
        strings[0] = "one";
        strings[1] = "two";
        stringArrayVar = Variable(
            Type(TypeKind.String, true),
            abi.encode(strings)
        );
    ...
    function test_Downcasting() public view {
        ...
        small_ints[0] = -10;
        small_ints[1] = 20;
        Variable memory intArraySmall = Variable(
            Type(TypeKind.Int256, true),
            abi.encode(small_ints)
        );
    ...
    function testRevert_TypeMismatch() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                LibVariable.TypeMismatch.selector,
                "uint256",
                "bool"
            )
        );
    ...
    function testRevert_UnsafeCast() public {
        ...
        Variable memory uintArrayLarge = Variable(
            Type(TypeKind.Uint256, true),
            abi.encode(uintArray)
        );
        expectedErr = abi.encodeWithSelector(
            LibVariable.UnsafeCast.selector,
        ...
        Variable memory intArrayLarge = Variable(
            Type(TypeKind.Int256, true),
            abi.encode(intArray)
        );
        expectedErr = abi.encodeWithSelector(
...
contract LibVariableHelper {
    ...
    function toInt32Array(
        Variable memory v
    ) external pure returns (int32[] memory) {
        return v.toInt32Array();
    }

    function toInt16Array(
        Variable memory v
    ) external pure returns (int16[] memory) {
        return v.toInt16Array();
    }

    function toInt8Array(
        Variable memory v
    ) external pure returns (int8[] memory) {
