...
contract ConfigTest is Test, Config {
    ...
    function test_loadConfig() public {
        ...
        bytes32[] memory bytes32_array = config
            .get(1, "word_array")
            .toBytes32Array();
        ...
        uint256[] memory uint_array = config
            .get(1, "number_array")
            .toUint256Array();
        ...
        int256[] memory int_array = config
            .get(1, "signed_number_array")
            .toInt256Array();
        ...
        string[] memory string_array = config
            .get(1, "str_array")
            .toStringArray();
    ...
    function test_writeConfig() public {
...

        {
            ...
            assertEq(
                vm.parseTomlAddress(content, "$.mainnet.address.weth"),
                new_addr
            );
            ...
            uint256[] memory updated_numbers_mem = config
                .get(10, "number_array")
                .toUint256Array();
            ...
            string[] memory updated_strings_mem = config
                .get(1, "str_array")
                .toStringArray();
            ...
            int256[] memory updated_ints_mem = config
                .get(10, "new_ints")
                .toInt256Array();
            ...
            content = vm.readFile(testConfig);
            int256[] memory updated_ints_disk = vm.parseTomlIntArray(
                content,
                "$.optimism.int.new_ints"
            );
            ...
            bytes32[] memory updated_words_mem = config
                .get(10, "new_words")
                .toBytes32Array();
            ...
            assertEq(
                vm.toString(updated_words_disk[0]),
                vm.toString(new_words[0])
            );
            assertEq(
                vm.toString(updated_words_disk[1]),
                vm.toString(new_words[1])
            );
        }
    ...
    function testRevert_InvalidChainKey() public {
        ...
        string
            memory invalidChainConfig = "./test/fixtures/config_invalid_chain.toml";
        vm.writeFile(
            invalidChainConfig,
            string.concat(
                "[mainnet]\n",
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                StdConfig.InvalidChainKey.selector,
                "invalid_chain"
            )
        );
    ...
    function testRevert_ChainNotInitialized() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                StdConfig.ChainNotInitialized.selector,
                uint256(999999)
            )
        );
    ...
    function testRevert_UnableToParseVariable() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                StdConfig.UnableToParseVariable.selector,
                "bad_value"
            )
        );
